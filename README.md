...
Documentation source lives in [`docs/`](./docs/) - English pages in `en/` (the default locale and source of truth) plus Chinese translations in `zh/` - and is synced to the central hub on every push to `main`.
